...
export default function LoginForm(){
  ...
  return (
    ...
    <form id="whoobe-t7qyk" className="justify-center items-center my-5 w-full shadow rounded-lg bg-gray-300 dark:bg-gray-700  px-6 flex flex-col md:w-1/2 lg:w-1/3 m-auto" onSubmit={submitHandler}>
    <h2 className="text-2xl my-4 text-gray-600 dark:text-gray-100">Login</h2>
