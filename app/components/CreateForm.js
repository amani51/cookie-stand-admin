      ...
      <section className=" flex justify-center ">
        ...
        >
          <div className="mt-7 mb-10 text-center border-b-2 dark:border-black ">
            <span className=" text-xl  text-gray-800 rounded-3xl border-1 border-gray-300 bg-gray-200 dark:bg-gray-400  py-4 px-5 shadow-lg">
              Create Cookie Stand
            </span>
          </div>
          <div className=" flex justify-center">
            ...
            <input
              ...
              className=" text-xl  text-gray-800 dark:text-gray-100 rounded-3xl border-1 border-gray-100 dark:bg-gray-400 bg-gray-100 py-4 px-5 shadow-lg w-3/5 ml-20 pl-10 mr-2"
            ></input>
          </div>
